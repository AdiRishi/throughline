...
6. [**Observability runbook**](./technical/06-observability.md) — where diagnostic evidence lands across the three processes, its correlation limits, and how to read it.
