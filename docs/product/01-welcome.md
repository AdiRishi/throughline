...
- **Paste a PR URL** — a secondary affordance, visually subordinate. It exists for the PR that isn't in your list: a public repository you want to try Throughline on, a one-off review. Same pipeline, different door.
