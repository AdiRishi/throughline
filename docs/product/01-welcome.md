...
- **Open settings** — a quiet gear in the title bar; harness choice and appearance live there, off the main surface. In the desktop app, Settings also offers one diagnostics action that opens Throughline's local logs folder for support and troubleshooting; the browser omits this native-only affordance.
