/**
 * Server metrics and the `withMetrics` wrapper that records them.
 *
 * Recording is always in-process; a configured OTLP collector URL only adds an
 * export of the same values.
 *
...
export const rpcRequestsTotal = Metric.counter("throughline_rpc_requests_total", {
  description: "Total RPC requests handled by the websocket RPC server.",
});

export const rpcRequestDuration = Metric.timer("throughline_rpc_request_duration", {
